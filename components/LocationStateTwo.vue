...
export default {
  ...
  data() {
      ...
      categories: [
    {
      icon: 'building',
      title: 'Sky Tower',
      subtitle: 'A luxurious high-rise offering unparalleled views and top-notch amenities for the ultimate urban living experience.'
    },
    {
      icon: ['fas', 'train-subway'],
      title: 'Intercity Bus Station',
      subtitle: 'The city hub for long-distance bus travel, built to streamline transportation and alleviate road congestion'
    },
    {
      icon: 'landmark',
    ...
    },
    {
      ...
      subtitle: 'A historic port with a modern twist, serving as a gateway for both cargo and adventurous travelers to far-off locales'
    }
  ],
